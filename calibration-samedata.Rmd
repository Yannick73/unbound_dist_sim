...
z1_x_vec <- c(0.3, -0.5, 0.6)
z1_y_vec <- c(0.3, 0.8, 0.5)
z2_y_vec <- c(0.2, 0.2, 0.2)
z3_x_vec <- c(0.2, 0.3, 0.3)
x_z4_vec <- c(-0.3, 0.25, 0.3)
y_z4_vec <- c(0.2, 0.01, 0.4)
x_y_vec  <- c(-0.35, 1.65, -0.55)
...
for (i in seq_len(nrow(data_config))) {
  ...
  if(is.na(data_config$x_y_coef[[i]])) {
    data_config$x_y_coef[[i]] <- x_y_vec[shape_index]
  }
