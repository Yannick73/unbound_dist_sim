...
z1_x_vec <- c(-0.5, -0.5, -0.6)
z1_y_vec <- c(0.2, 0.2, 0.2)
z2_y_vec <- c(0.05, 0.05, 0.05)
z3_x_vec <- c(0.2, 0.2, 0.2)
x_z4_vec <- c(0.1, 0.1, 0.1)
y_z4_vec <- c(0.1, 0.1, 0.1)
x_y_vec  <- c(0.4, 1.5, 0.5)
