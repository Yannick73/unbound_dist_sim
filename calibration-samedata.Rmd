...
z1_x_vec <- c(0.8, -0.5, 0.5)
z1_y_vec <- c(0.2, 0.2, 0.4)
z2_y_vec <- c(0.1, 0.1, 0.2)
z3_x_vec <- c(0.3, 0.3, 0.5)
x_z4_vec <- c(-0.25, 0.2, 0.2)
y_z4_vec <- c(0.3, -0.05, 0.2)
x_y_vec  <- c(-0.35, -1.5, -0.5)
