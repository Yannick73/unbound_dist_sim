...
z1_x_vec <- c(-0.8, -0.5, -0.6)
z1_y_vec <- c(0.2, 0.2, 0.3)
z2_y_vec <- c(0.1, 0.1, 0.1)
z3_x_vec <- c(0.3, 0.3, 0.3)
x_z4_vec <- c(0.15, 0.2, 0.2)
y_z4_vec <- c(0.2, -0.05, -0.05)
x_y_vec  <- c(0.3, 1.5, 0.5)
