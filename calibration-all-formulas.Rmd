...
NCORES <- 8 # physical cores -1 or less
...
z1z2_y_list <- list(
  ...
  # "gaussian" = list(c(0.5, 0.5), c(0.3, 0.5)),
  ...
  "skew_normal" = list(c(0.05, 0.3), c(0.05, 0.1), c(0.05, 0.3)), #skewed FPR too low
...
z1z3_x_list <- list(
  # "gaussian" = list(c(0.15, 0.15), c(0.03, 0.3)),
  ...
  "skew_normal" = list(c(0.05, 0.05), c(0.03, 0.1), c(0.06, 0.1)), #skewed FPR too low
...
x_y_z4_list <- list(
  ...
  "skew_normal" = list(c(0.1, 0.2), c(0.03, 0.02), c(0.05, 0.1)), #skewed FPR too low
