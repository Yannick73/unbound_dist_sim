...
DATASET_N <- 5 # 5-10-ish for calibration, 200 for the final experiment
...
z1z3_x_list <- list(
  "gaussian" = list(c(1, 0.3), c(1, 0.3)),
  # "gaussian" = list(c(0.1, 0.3), c(0.1, 0.3)),
  # "gaussian" = list(c(0.15, 0.1), c(0.3, 0.1)), #bias2 nice
  "student" = list(c(0.5, 1), c(0.5, 1)),
...
x_y_z4_list <- list(
  # "gaussian" = list(c(0.05, 0.05), c(0.05, 0.05)),#bias2 nice
  # "gaussian" = list(c(0.05, 0.05), c(0.2, 0.2)),#
  "gaussian" = list(c(0.5, 0.5), c(0.5, 0.5)),
  "student" = list(c(1, 1), c(1, 1)),
