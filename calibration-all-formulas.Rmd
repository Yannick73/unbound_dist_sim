...
NCORES <- 2 # physical cores -1 or less
...
z1z2_y_list <- list(
  # "gaussian" = list(c(0.5, 0.5), c(1, 1)),
  "gaussian" = list(c(0.5, 0.5), c(0.01, 0.05)),
  # "gaussian" = list(c(0.5, 0.5), c(0.1, 2)),
...
z1z3_x_list <- list(
  # "gaussian" = list(c(0.1, 0.1), c(0.3, 0.45)),# nice
  # "gaussian" = list(c(0.15, 0.1), c(0.45, 0.45)),# also nice
  # "gaussian" = list(c(0.15, 0.15), c(0.45, 0.45)),
...
x_y_z4_list <- list(
  ...
  # "gaussian" = list(c(0.16, 0.16), c(0.06, 0.06)),#nice
  "gaussian" = list(c(0.16, 0.16), c(0.09, 0.06)),
