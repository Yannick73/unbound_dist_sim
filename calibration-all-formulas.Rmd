...
=======
NCORES <- 4 # physical cores -1 or less
>>>>>>> 45d5e125a9d770cb3b111992425a7f509a834841
...
z1z2_y_list <- list(
<<<<<<< HEAD
  # "gaussian" = list(c(0.5, 0.5), c(0.01, 0.05)),
  # "gaussian" = list(c(-0.06, 0.03), c(-0.06, 0.03)),
...
x_y_list <- list(
<<<<<<< HEAD
  # "gaussian"     = c(0.45, 2),# maybe increase, as soon, as TPR reducing unbiased2 is found!
   "gaussian"     = c(0.45, 2),
=======
  "gaussian"     = c(0.45, 2),
  # "student"      = c(0.5, 1.2),
