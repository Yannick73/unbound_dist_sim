...
# unix::rlimit_as(1.2e12)  #increases to ~12GB
```
...
RESULT_PATH <- "~/Dokumente/simresults"
...
# z1z2_y_list <- list(
#   "gaussian" = list(c(0.1, -0.1), c(0.1, 0.1)),
#   "student" = list(c(-0.2, 0.1), c(-0.2, 0.1)),
#   "skew_normal" = list(c(0.02, 0.2), c(0.05, 0.2), c(0.08, 0.2)),
#   "generalized_normal" = list(c(0.02, 0.1), c(0.1, 0.05)),
#   "asym_laplace" = list(c(0.05, 0.2), c(0.05, 0.2), c(0.05, 0.1)),
...
#   "gaussian"     = c(0.45, 2),
#   "student"      = c(0.5, 2.5),
#   "skew_normal"  = c(0.45, 1.6, 0.5),
#   "generalized_normal" = c(0.14, 2.6),
#   "asym_laplace" = c(0.7, 1.5, 0.75),
...
# 
# z1z3_x_list <- list(
#   "gaussian" = list(c(0.1, 0.1), c(0.1, 0.3)),
#   "student" = list(c(0.1, 0.2), c(0.1, 0.2)),
#   "skew_normal" = list(c(0.05, 0.05), c(0.03, 0.1), c(0.1, 0.1)),
#   "generalized_normal" = list(c(0.01, 0.1), c(0.01, 0.1)),
#   "asym_laplace" = list(c(0.05, 0.1), c(0.05, 0.1), c(0.1, 0.1)),
...
# x_y_z4_list <- list(
#   "gaussian" = list(c(0.15, 0.20), c(0.08, 0.07)),
#   "student" = list(c(0.1, 0.1), c(0.01, 0.01)),
#   "skew_normal" = list(c(0.1, 0.2), c(0.03, 0.02), c(0.05, 0.1)),
#   "generalized_normal" = list(c(0.3, 0.15), c(0.08, 0.02)),
#   "asym_laplace" = list(c(0.05, 0.1), c(0.02, 0.02), c(0.05, 0.1)),
...
for (i in seq_len(nrow(data_config))) {
  ...
  if(is.na(data_config$x_y_coef[[i]])) {
    ...
    if(family == "symlognormal") {
      data_config$x_y_coef[[i]] <- x_y_list[[shape_index]] * 0.7
    }
    else {
      data_config$x_y_coef[[i]] <- x_y_list[[shape_index]]
    }
  }
}
