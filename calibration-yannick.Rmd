...
z1z2_y_list <- list(
  "gaussian" = list(c(6, 6), c(0.3, 0.3)),
  "student" = list(c(1.5, 1.5), c(1.5, 1.5)),
  "skew_normal" = list(c(2, 2), c(2, 2), c(24, 24)),
  "generalized_normal" = list(c(2, 2), c(2, 2)),
  "asym_laplace" = list(c(0.7, 0.7), c(16, 16), c(3, 3)),
  "exgaussian" = list(c(20, 20), c(20, 20), c(5, 5)),
  "gumbel" = list(NA, c(14, 14), c(1.8, 1.8)),
  "logistic" = list(c(1.2, 1.2), c(16, 16)),
  "symlognormal" = list(c(3, 3), c(3, 3), c(0.8, 0.8))
)
