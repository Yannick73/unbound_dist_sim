...
DATASET_N <- 100 # 5-10-ish for calibration, 200 for the final experiment
...
z1z2_y_list <- list(
  "gaussian" = list(c(15, 15), c(8, 8)),
  "student" = list(c(2, 2), c(2, 2)),
  "skew_normal" = list(c(0.5, 0.5), c(0.1, 0.1), c(0.5, 0.5)),
  "generalized_normal" = list(c(0.1, -32.5), c(-3.2, -3.2)),#think, -3.2 was about 6%
  # arg gen-normal thin FPR moment only about 2%!
  # 0.1 and -32 are 3% YES!
  "asym_laplace" = list(c(1, 1), c(3.5, 3.5), c(30, 30)),
  "exgaussian" = list(NA, NA, c(1, 1)),
  "gumbel" = list(NA, c(-1, 1), c(0.5, 0.5)),
  "logistic" = list(c(1.9, 1.9), c(3, 3)),
  "symlognormal" = list(c(-0.2, -0.2), c(9, 9), c(0.5, 0.5))
)
