...
sigma_y_list <- list(
  "gaussian" = c(1.2, 10), # if equal x_y_coeff, 0 FPR in y ~ x + z1 + z2
  "gumbel" = c(NA, 8, 0.5), # no thin, form (so NA). wide - skewed
  "symlognormal" = c(1, 8, 1.5),
  "skew_normal" = list(c(1, 0), c(5, 0), c(1, 10))
)
# Given our aux is usually log, compare to log reference
y_intercept_list <- c(0.5, 0.5, 5)
x_y_coef_list <- c(5, 5, 0.5)
