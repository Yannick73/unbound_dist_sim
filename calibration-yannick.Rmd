...
z1z2_y_list <- list(
  "gaussian" = list(c(15, 15), c(25, 25)),
  "student" = list(c(0.5, 0.5), c(2, 2)),
  "skew_normal" = list(c(0.1, 0.1), c(0.3, 0.3), c(5, 5)),
  "generalized_normal" = list(c(8, 8), c(1.2, 1.2)),
  "asym_laplace" = list(c(0.15, 0.15), c(5, 5), c(5, 5)),
  "exgaussian" = list(c(4, 4), c(4, 4), c(2.5, 2.5)),
  "gumbel" = list(NA, c(0.1, 0.1), c(0.5, 0,5)),
  "logistic" = list(c(8, 8), c(3, 3)),
  "symlognormal" = list(c(3.3, 3.3), c(0.5, 0.5), c(0.1, 0.1))
)

sigma_y_list <- list(
  "gaussian" = c(1.2, 9), # if equal x_y_coeff, 0 FPR in y ~ x + z1 + z2
  "student" = list(c(10, 1), c(10, 5)), # student only really does thin
  "skew_normal" = list(c(1, 0), c(5, 0), c(1, 8)),
  "generalized_normal" = list(c(1, 2), c(1, 0.8)), # 0.8 is not as wide as possible
