...
wide_filter <- c("student", "exgaussian")
...
sigma_y_list <- list(
  ...
  "student" = list(c(10, 1)), # student only really does thin
  "skew_normal" = list(c(1, 0), c(5, 0), c(1, 8)),
  #"generalized_normal" = list(c(1, 10), c(1,0.5)),
  "asym_laplace" = list(c(0.3, 0.5), c(5, 0.5), c(0.6, 0.1)),
  "exgaussian" = list(NA, NA, c(1, 2)),
...
y_intercept_list <- c(0.5, 0.5, -5)
x_y_coef_list <- list(
  "gaussian"     = c(0.37, 2.17),
  "student"      = c(0.3),
  "skew_normal"  = c(0.37, 1.67, 0.27),
  #"generalized_normal" = list(c(1, 10), c(1,0.5)),
  "asym_laplace" = c(0.17, 3.38, 0.9),
  "exgaussian"   = c(NA,   NA,    0.65),
  "gumbel"       = c(NA,   3.43,  0.13),
  "logistic"     = c(0.57, 2.17),
  "symlognormal" = c(0.27, 2.42, 0.62)
)
