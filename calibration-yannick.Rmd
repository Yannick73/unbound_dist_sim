...
x_y_coef_list <- list(
  "gaussian"     = c(0.5, 2.2),
  "student"      = c(0.38),
  "skew_normal"  = c(0.32, 1.67, 0.24),
  #"generalized_normal" = list(c(1, 10), c(1,0.5)),
  "asym_laplace" = c(0.25, 3.32, 1.00),
  "exgaussian"   = c(NA,  NA,   0.618),
  "gumbel"       = c(NA,  3.42, 0.158),
  "logistic"     = c(0.55, 3.14),
  "symlognormal" = c(0.35, 2.45, 0.613)
)
