...
z1z2_y_list <- list(
  "gaussian" = list(c(2, 2), c(1, 1)),
  "student" = list(c(2, 2)),
  "skew_normal" = list(c(2, 2), c(2, 2), c(4, 4)),
  "asym_laplace" = list(c(1, 1), c(4, 4), c(4, 4)),
  "exgaussian" = list(NA, NA, c(4, 4)),
  "gumbel" = list(NA, c(4, 4), c(1, 1)),
  "logistic" = list(c(1, 1), c(4, 4)),
  "symlognormal" = list(c(2, 2), c(2, 2), c(1, 1))
)
