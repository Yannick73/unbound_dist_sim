...
z1z2_y_list <- list(
  ...
  "generalized_normal" = list(c(0.5, 0.5), c(-3.2, -3.2)),#think, -3.2 was about 6%
  # arg gen-normal thin FPR moment only about 2%!
  "asym_laplace" = list(c(1, 1), c(3.5, 3.5), c(30, 30)),
  "exgaussian" = list(c(7.5, 7.5), NA, c(12, 12)),
...
sigma_y_list <- list(
  ...
  "generalized_normal" = list(c(1.5, 2), c(4, 0.8)), # 0.8 is not as wide as possible
